...
Densenet-121 Model Reference: Huang, G., Liu, Z., Van Der Maaten, L., & Weinberger, K. Q. (2018).
...
def main():
    ...
    CONFIG = {                                           # Dataset configuration
       ...
       # Training parameters
        ...
        'num_workers': 8,                                # CPU workers for data loading (adjust according to resources)
        ...
        # 'classifier_dropout': 0.5,                     # Higher dropout in final classifier
