...
def main():
    ...
    # Begin logging
    original_stdout, log_file, log_file_path = start_logging('VGG-16', '../../Results/logs/')
    ...
    CONFIG = {
        ...
        'save_path': '../../Results/models/VGG-16_best.pth',  # Best model checkpoint
        'log_dir': '../../Results/logs/',                     # Training logs directory
        'plots_dir': '../../Results/plots/',                  # Plots and visualizations directory
    }
