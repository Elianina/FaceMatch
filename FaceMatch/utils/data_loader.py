...
def get_transforms(image_size=224):
    ...
    train_transform = transforms.Compose([       # Targets training set augmentation/s
        transforms.Resize((image_size, image_size)),      # Resize image to specified resolution
...
def create_data_loaders(img_dir, attr_file, batch_size=128, num_workers=4,
    ...
    A function to create stratified data loaders for the CelebA gender classification problem.
        ...
        Args:
            ...
            image_size (int): The size of the images (224 pixels)
