"""
ResNet-50 Gender Classification
...
def main():
    ...
    CONFIG = {
        ...
        # --- ResNet-50 specific ---
        'classifier_dropout': 0.5,   # Dropout in final classifier head
        'block_drop_rate': 0.0,      # Dropout inside each Bottleneck (optional, e.g., 0.05)
    ...
    print("\n" + "=" * 62)
    print("ResNet-50 Gender Classification")
    print("=" * 62 + "\n")
    ...
    print("=" * 62)
    print("Initialising ResNet-50 Model")
    print("=" * 62 + "\n")

    print("Model Configuration:")
    print(f"\tClassifier Dropout: {CONFIG['classifier_dropout']}")
    print(f"\tBlock Dropout: {CONFIG['block_drop_rate']}")
    print(f"\tNumber of Classes: {CONFIG['num_classes']} (Male/Female)")
    print()

    # ResNet50 Gender
    model = ResNet50Gender(
        layers=(3, 4, 6, 3), # ResNet-50 layers
        num_classes=CONFIG['num_classes'],
        classifier_dropout=CONFIG['classifier_dropout'],
        block_drop_rate=CONFIG['block_drop_rate'],
    ...
    try:
        ...
        if results is not None:
            ...
            print("ResNet-50 training completed successfully!")
